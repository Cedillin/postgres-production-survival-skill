...
| [PostgreSQL documentation](https://www.postgresql.org/docs/) | Primary technical authority, matched to the deployed major version, used to verify version-sensitive behavior such as progress-view columns, replication diagnostics, `CREATE INDEX CONCURRENTLY`, `VACUUM`, UUIDv7, locking, and partition maintenance. |
